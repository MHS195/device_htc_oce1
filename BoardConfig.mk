...
BOARD_KERNEL_CMDLINE := console=ttyHSL0,115200,n8 androidboot.console=ttyHSL0 user_debug=31 ehci-hcd.park=3 cma=32M@0-0xffffffff printk.devkmsg=on androidboot.hardware=qcom androidkey.dummy=1 loop.max_part=7 androidboot.boot_devices=soc/624000.ufshc
...
TARGET_LD_SHIM_LIBS := \
    ...
    /system/vendor/lib/hw/camera.msm8996.so|/system/vendor/lib/libmemset_shim.so \
